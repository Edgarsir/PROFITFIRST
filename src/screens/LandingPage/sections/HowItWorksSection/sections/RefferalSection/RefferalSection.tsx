  ...
  return (
    <div className="flex flex-col w-full max-w-[360px] 3xl:max-w-[420px] items-start gap-[40px] 3xl:gap-[47px] xl:absolute xl:top-[150px] 3xl:xl:top-[200px] xl:left-[840px] 3xl:xl:left-[987px]">
      <div className="relative self-stretch w-full h-[340px] 3xl:h-[397px] bg-[#1e1e1e] rounded-[12px] 3xl:rounded-[14px]">
        ...
        {/* Top plane */}
        <img className="absolute top-[120px] 3xl:top-[143px] left-[168px] 3xl:left-[198px] w-[24px] 3xl:w-[28px] h-[24px] 3xl:h-[28px]" alt="Paper airplane" src="/src/assets/images/Paper Airplane Flat Top View PNG & SVG Design For T-Shirts 1.png" />
        {/* Middle plane */}
        <img className="absolute top-[155px] 3xl:top-[185px] left-[168px] 3xl:left-[198px] w-[24px] 3xl:w-[28px] h-[24px] 3xl:h-[28px]" alt="Paper airplane" src="/src/assets/images/Paper Airplane Flat Top View PNG & SVG Design For T-Shirts 1.png" />
        {/* Bottom plane */}
        <img className="absolute top-[190px] 3xl:top-[227px] left-[168px] 3xl:left-[198px] w-[24px] 3xl:w-[28px] h-[24px] 3xl:h-[28px]" alt="Paper airplane" src="/src/assets/images/Paper Airplane Flat Top View PNG & SVG Design For T-Shirts 1.png" />
        
        {/* User avatars for Facebook - images 9, 10, 11 */}
        <img className="absolute top-[190px] 3xl:top-[227px] left-[55px] 3xl:left-[65px] w-[48px] 3xl:w-[56px] h-[38px] 3xl:h-[45px] rounded-full object-cover" alt="User avatar" src="/src/assets/images/image 9.png" />
        <img className="absolute top-[150px] 3xl:top-[180px] left-[82px] 3xl:left-[97px] w-[48px] 3xl:w-[56px] h-[38px] 3xl:h-[45px] rounded-full object-cover" alt="User avatar" src="/src/assets/images/image 10.png" />
        <img className="absolute top-[115px] 3xl:top-[138px] left-[115px] 3xl:left-[136px] w-[48px] 3xl:w-[56px] h-[38px] 3xl:h-[45px] rounded-full object-cover" alt="User avatar" src="/src/assets/images/image 11.png" />
        
        {/* User avatars for Shiprocket - images 12, 13, 14 */}
        <img className="absolute top-[190px] 3xl:top-[227px] left-[250px] 3xl:left-[295px] w-[48px] 3xl:w-[56px] h-[38px] 3xl:h-[45px] rounded-full object-cover" alt="User avatar" src="/src/assets/images/image 12.png" />
        <img className="absolute top-[150px] 3xl:top-[180px] left-[225px] 3xl:left-[265px] w-[48px] 3xl:w-[56px] h-[38px] 3xl:h-[45px] rounded-full object-cover" alt="User avatar" src="/src/assets/images/image 14.png" />
        <img className="absolute top-[115px] 3xl:top-[138px] left-[200px] 3xl:left-[236px] w-[48px] 3xl:w-[56px] h-[38px] 3xl:h-[45px] rounded-full object-cover" alt="User avatar" src="/src/assets/images/image 14.png" />
      </div>
